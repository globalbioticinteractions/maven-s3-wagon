...
public class S3Listener implements TransferListener, SessionListener {
    ...
    public void sessionDisconnected(final SessionEvent sessionEvent) {
        ...
        sb
                .append("Transfers: ")
                .append(transferCount)
                .append(" Time: ").append(formatter.getTime(elapsed))
                .append(" Amount: ").append(formatter.getSize(byteCount))
                .append(" Throughput: ").append(formatter.getRate(elapsed, byteCount));
        if (transferCount > 0) {
